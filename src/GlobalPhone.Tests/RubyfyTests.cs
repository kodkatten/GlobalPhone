...
namespace GlobalPhone.Tests
{
    ...
    public class RubyfyTests
    {
        ...
        public void test_flatten_generic()
        {
            ...
            assert_equal(new[] { 1, 2, 3, 4, 5, 6 }, a4.Flatten<int>());
            assert_equal(new object[] { a1, a3 }, a4);

            var a5 = new object[] { a1, new object[0], a3 };
            assert_equal(new object[] { 1, 2, 3, 4, 5, 6 }, a5.Flatten<int>());
            assert_equal(new object[0], new object[0].Flatten<int>());
            assert_equal(new object[0],
                           new object[] { new object[] { new object[] { new object[] { }, new object[] { } }, new object[] { new object[] { } }, new object[] { } }, new object[] { new object[] { new object[] { } } } }.Flatten<int>());
        }
